-- +goose Up
-- Baseline schema squashed from db.go's historical migrate() (v1..v73).
-- Future migrations live in 00002_*.sql onward.
...
DROP INDEX IF EXISTS idx_users_is_stub;
DROP INDEX IF EXISTS idx_channels_name;
DROP INDEX IF EXISTS idx_channels_type;
DROP INDEX IF EXISTS idx_channels_is_archived;
DROP INDEX IF EXISTS idx_channels_is_member;
DROP INDEX IF EXISTS idx_messages_user_id;
DROP INDEX IF EXISTS idx_messages_thread;
DROP INDEX IF EXISTS idx_messages_ts_unix;
DROP INDEX IF EXISTS idx_messages_channel_ts_unix;
DROP INDEX IF EXISTS idx_reactions_message;
DROP INDEX IF EXISTS idx_files_message;
DROP INDEX IF EXISTS idx_digests_channel;
DROP INDEX IF EXISTS idx_digests_type;
DROP INDEX IF EXISTS idx_digests_period;
DROP INDEX IF EXISTS idx_digest_participants_user;
DROP INDEX IF EXISTS idx_digest_topics_digest;
DROP INDEX IF EXISTS idx_user_analyses_user;
DROP INDEX IF EXISTS idx_user_analyses_period;
DROP INDEX IF EXISTS idx_period_summaries_period;
DROP INDEX IF EXISTS idx_tracks_priority;
DROP INDEX IF EXISTS idx_tracks_has_updates;
DROP INDEX IF EXISTS idx_tracks_updated;
DROP INDEX IF EXISTS idx_tracks_ownership;
DROP INDEX IF EXISTS idx_tracks_assignee;
DROP INDEX IF EXISTS idx_track_states_track;
DROP INDEX IF EXISTS idx_targets_level;
DROP INDEX IF EXISTS idx_targets_parent;
DROP INDEX IF EXISTS idx_targets_period;
DROP INDEX IF EXISTS idx_targets_status;
DROP INDEX IF EXISTS idx_targets_priority;
DROP INDEX IF EXISTS idx_targets_due;
DROP INDEX IF EXISTS idx_targets_source;
DROP INDEX IF EXISTS idx_targets_updated;
DROP INDEX IF EXISTS idx_target_links_source;
DROP INDEX IF EXISTS idx_target_links_target;
DROP INDEX IF EXISTS idx_target_links_external;
DROP INDEX IF EXISTS idx_inbox_items_status;
DROP INDEX IF EXISTS idx_inbox_items_priority;
DROP INDEX IF EXISTS idx_inbox_items_updated;
DROP INDEX IF EXISTS idx_inbox_items_sender;
DROP INDEX IF EXISTS idx_inbox_items_snooze;
DROP INDEX IF EXISTS idx_inbox_items_class_status;
DROP INDEX IF EXISTS idx_inbox_items_pinned;
DROP INDEX IF EXISTS idx_inbox_items_archived;
DROP INDEX IF EXISTS idx_inbox_learned_rules_scope;
DROP INDEX IF EXISTS idx_inbox_feedback_item;
DROP INDEX IF EXISTS idx_feedback_entity;
DROP INDEX IF EXISTS idx_feedback_rating;
DROP INDEX IF EXISTS idx_prompt_history_prompt;
DROP INDEX IF EXISTS idx_prompt_history_version;
DROP INDEX IF EXISTS idx_dic_dedup;
DROP INDEX IF EXISTS idx_dic_created;
DROP INDEX IF EXISTS idx_user_interactions_a;
DROP INDEX IF EXISTS idx_communication_guides_user;
DROP INDEX IF EXISTS idx_communication_guides_period;
DROP INDEX IF EXISTS idx_people_cards_user;
DROP INDEX IF EXISTS idx_people_cards_period;
DROP INDEX IF EXISTS idx_briefings_user_date;
DROP INDEX IF EXISTS idx_pipeline_runs_pipeline;
DROP INDEX IF EXISTS idx_pipeline_runs_started;
DROP INDEX IF EXISTS idx_pipeline_steps_run;
DROP INDEX IF EXISTS idx_calendar_events_calendar;
DROP INDEX IF EXISTS idx_calendar_events_start;
DROP INDEX IF EXISTS idx_calendar_events_end;
DROP INDEX IF EXISTS idx_meeting_prep_cache_generated;
DROP INDEX IF EXISTS idx_jira_issues_project;
DROP INDEX IF EXISTS idx_jira_issues_assignee;
DROP INDEX IF EXISTS idx_jira_issues_status_cat;
DROP INDEX IF EXISTS idx_jira_issues_sprint;
DROP INDEX IF EXISTS idx_jira_issues_epic;
DROP INDEX IF EXISTS idx_jira_issues_updated;
DROP INDEX IF EXISTS idx_jira_issues_due;
DROP INDEX IF EXISTS idx_jira_issues_board;
DROP INDEX IF EXISTS idx_jira_slack_links_issue;
DROP INDEX IF EXISTS idx_jira_slack_links_channel;
DROP INDEX IF EXISTS idx_jira_slack_links_track;
DROP INDEX IF EXISTS idx_jira_slack_links_digest;
DROP INDEX IF EXISTS idx_jira_issues_assignee_slack;
DROP INDEX IF EXISTS idx_jira_issues_assignee_status;
DROP INDEX IF EXISTS idx_meeting_notes_event;
DROP INDEX IF EXISTS idx_day_plans_date;
DROP INDEX IF EXISTS idx_day_plans_user_date;
DROP INDEX IF EXISTS idx_day_plan_items_plan;
DROP INDEX IF EXISTS idx_day_plan_items_source;
DROP TABLE IF EXISTS day_plan_items;
DROP TABLE IF EXISTS day_plans;
DROP TABLE IF EXISTS jira_releases;
...
DROP TABLE IF EXISTS jira_slack_links;
DROP TABLE IF EXISTS jira_user_map;
DROP TABLE IF EXISTS jira_issue_links;
DROP TABLE IF EXISTS jira_sprints;
DROP TABLE IF EXISTS jira_issues;
DROP TABLE IF EXISTS jira_board_field_map;
DROP TABLE IF EXISTS jira_custom_fields;
DROP TABLE IF EXISTS jira_boards;
DROP TABLE IF EXISTS meeting_prep_cache;
DROP TABLE IF EXISTS calendar_attendee_map;
...
DROP TABLE IF EXISTS people_card_summaries;
DROP TABLE IF EXISTS people_cards;
...
DROP TABLE IF EXISTS inbox_learned_rules;
DROP TABLE IF EXISTS inbox_items;
DROP TABLE IF EXISTS target_links;
DROP TABLE IF EXISTS targets;
DROP TABLE IF EXISTS track_states;
DROP TABLE IF EXISTS tracks;
DROP TABLE IF EXISTS custom_emojis;
DROP TABLE IF EXISTS period_summaries;
DROP TABLE IF EXISTS user_analyses;
DROP TABLE IF EXISTS decision_reads;
DROP TABLE IF EXISTS digest_topics;
DROP TABLE IF EXISTS digest_participants;
