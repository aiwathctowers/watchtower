...
type Digest struct {
	...
	PromptVersion int            // version of prompt used for generation
	PeopleSignals string         // JSON array of PersonSignals from MAP phase
}
...
// Generated by the REDUCE phase from people_signals in channel digests.
type PeopleCard struct {
	...
	HowToCommunicate    string  // coaching paragraph
